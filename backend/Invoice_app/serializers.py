...
#         ]
#         InvoiceMethod.objects.filter(payment=instance).exclude(
...
#         invoice_methods = InvoiceMethod.objects.filter(payment=instance)
#         representation["invoice_methods"] = InvoiceMethodSerializer(
