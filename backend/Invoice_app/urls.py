...
from Invoice_app.views import (
    ...
    LoginView,
    EntityRetrieveUpdateDeleteAPIView,
)
...
from .views import (
    ...
    ItemZoneViewSet,
    # GenerateXLS,
    # InvoiceMethodListCreateAPIView,
    # InvoiceMethodRetrieveUpdateDeleteAPIView,
    PaymentListCreateAPIView,
    PaymentRetrieveUpdateDeleteAPIView,
    ProjectListCreateAPIView,
    ProjectRetrieveUpdateDeleteAPIView,
    ScheduleListCreateAPIView,
    ScheduleRetrieveUpdateDeleteAPIView,
    SignUpView,
    PaymentBoQDetailedListCreateAPIView
)
...
router.register(r'item-zones', ItemZoneViewSet)
router.register(r'item-units', ItemUnitViewSet)
...
urlpatterns = [
    ...
    path(
        "entities/<int:pk>/",
        EntityRetrieveUpdateDeleteAPIView.as_view(),
        name="entity-detail-update-delete",
    ),
    ...
    path(
        "projects/<int:pk>/",
        ProjectRetrieveUpdateDeleteAPIView.as_view(),
        name="project-detail",
    ),
    path(
    ...
    path(
        "schedule/<int:pk>/",
        ScheduleRetrieveUpdateDeleteAPIView.as_view(),
        name="schedule-detail",
    ),
    path("payment/", PaymentListCreateAPIView.as_view(), name="payment-list-create"),
    path(
        "payment/<int:pk>/",
        PaymentRetrieveUpdateDeleteAPIView.as_view(),
        name="Payment-detail",
    ),
    path(
    ...
    # path(
    #     "invoice/", InvoiceMethodListCreateAPIView.as_view(), name="invoice-list-create"
    # ),
    # path(
    #     "invoice/<int:pk>/",
    #     InvoiceMethodRetrieveUpdateDeleteAPIView.as_view(),
    #     name="invoice-detail",
    # ),
    # path(
    #     "generate_invoice_XLS/<int:payment_id>/",
    #     GenerateXLS.as_view(),
    #     name="generate_invoice_XLS",
    # ),
