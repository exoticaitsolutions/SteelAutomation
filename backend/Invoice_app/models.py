...
class PaymentBoQDetailed(models.Model):
    ...
    acw = models.DecimalField(max_digits=30, decimal_places=10, default=0)
    pcs = models.IntegerField(default=0)
    qty = models.DecimalField(max_digits=30, decimal_places=10, default=0)
    item = models.CharField(max_length=50)
    rate = models.DecimalField(max_digits=30, decimal_places=1, default=0)
