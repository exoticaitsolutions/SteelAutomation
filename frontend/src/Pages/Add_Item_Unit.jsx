...
function AddItemUnit() {
    ...
    const apiUrls = {
        baseUrl: `${process.env.REACT_APP_API_BASE_URL}/api/item-units/`,
        redirectUrl: '/dashboard/item_units',
    };
                    ...
                    <section className="add_contract_page">
                        <div className="container">
                            <form className="form" onSubmit={handleSubmit}>
                                ...
                                <h2>{isEditing ? 'Edit Item_Unit' : 'Add Item_Unit'}</h2>
                                    </div>
                                    <div className="sec_field">
                                        <label>Item_Unit name:</label>
                                        <input 
                                            type="text" 
                                            name="name" 
